 ...
 */
public class QuestionAnswer_3_3_12 {
    /*
     * Вопрос: На игровом поле находится робот. Позиция робота на поле описывается двумя
     ...
     * }
     *
     * Ответ: см. ниже ---- скопировать всё, что внутри символов /*     */
