 ...
 */
public class QuestionAnswer_4_3_9 {
    /*
     * Вопрос: Это задачка совмещает тренировку по материалу предыдущих двух модулей –
     * необходимо разобраться и написать объект-ориентированный код и при этом коснуться
     * свежих тем – исключений и логирования.
     *
     ...
     * Ответ: см. ниже, строки с 25 по 29, без "//" вначале
     *
     */
